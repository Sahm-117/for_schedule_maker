-- Production Migration Script - FIXED for UUID
...
ALTER TABLE "Activity" ADD COLUMN "userId" UUID;

-- Step 2: Create system users for data integrity (using proper UUIDs)
...
SELECT
    ...
    NOW()
WHERE NOT EXISTS (
    SELECT 1 FROM "User" WHERE id = 'a0000000-0000-4000-8000-000000000001'::UUID
);
...
SELECT
    ...
    NOW()
WHERE NOT EXISTS (
    SELECT 1 FROM "User" WHERE id = 'a0000000-0000-4000-8000-000000000002'::UUID
);
