    ...
    <div className="fixed bottom-20 left-4 right-4 z-40 max-w-md mx-auto">
      <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-4 flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          <p className="text-sm font-medium text-gray-900">Install FOF SOP Manager</p>
          <p className="text-xs text-gray-500 truncate">Add to your home screen for the best experience</p>
        </div>
