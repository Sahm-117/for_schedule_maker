...
const ActivityModal: React.FC<ActivityModalProps> = ({
  ...
  const handleDelete = () => {
    ...
    // Close edit modal and trigger delete flow (which will open MultiWeekDeleteModal)
    onClose();
    onDelete(activity);
  };
            ...
            <div className="flex flex-col sm:flex-row justify-between pt-4 border-t gap-3">
              ...
              <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-primary text-white rounded-md hover:bg-primary-dark disabled:opacity-50 text-sm sm:text-base inline-flex items-center justify-center gap-2"
                >
                  {loading && (
