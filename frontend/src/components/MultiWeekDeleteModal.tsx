            ...
            {propExistingWeeks.length > 1 && (
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  disabled={selectedWeeks.length === 0 || loading}
                  className={`flex-1 px-4 py-2 text-white rounded-lg disabled:opacity-50 disabled:cursor-not-allowed transition-colors inline-flex items-center justify-center gap-2 ${
