    ...
    <>
      <div className="pointer-events-none fixed inset-x-0 bottom-20 z-40 flex justify-end px-4 lg:bottom-6 lg:px-6">
        <button
          ...
          className="pointer-events-auto inline-flex items-center gap-2 rounded-full bg-primary px-5 py-3 text-sm font-semibold text-white shadow-[0_12px_30px_rgba(255,145,77,0.45)] transition hover:bg-primary-dark active:scale-95"
        >
          {/* headset icon */}
