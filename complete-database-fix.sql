-- Complete database fix for FOF Schedule Editor
-- This script fixes all database issues and ensures proper structure
...
-- 2. Create all days for all weeks with proper Sunday-first ordering
DO $$
DECLARE
    week_record RECORD;
